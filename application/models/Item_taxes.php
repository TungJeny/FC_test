...
class Item_taxes extends CI_Model
{
    ...
    function save_multiple(&$items_taxes_data, $item_ids, $select_inventory = false)
    {
        if ($select_inventory) {
            ...
            $result = $this->Item->search(isset($params['search']) ? $params['search'] : '', isset($params['category_id']) ? $params['category_id'] : '', $this->Item->count_all(), 0, 'name', 'asc', isset($params['fields']) ? $params['fields'] : 'all');
