...
class Detailed_timeclock extends Report
{
    ...
    public function getDataColumns()
    {
        ...
        if (! isset($this->params['is_view_only_self']) || $this->params['is_view_only_self'] == false) {
            ...
            $columns[] = array(
                'data' => lang('reports_employee'),
                'align' => 'left'
            );
        }
        $columns[] = array(
            'data' => lang('common_clock_in'),
            'align' => 'left'
        );
        $columns[] = array(
            'data' => lang('common_clock_out'),
            'align' => 'left'
        );
        $columns[] = array(
            'data' => lang('reports_hours'),
            'align' => 'left'
        );
        $columns[] = array(
            'data' => lang('common_hourly_pay_rate'),
            'align' => 'left'
        );
        $columns[] = array(
            'data' => lang('common_total'),
            'align' => 'left'
        );
        $columns[] = array(
            'data' => lang('common_clock_in_comment'),
            'align' => 'left'
        );
        $columns[] = array(
            'data' => lang('common_clock_out_comment'),
            'align' => 'left'
        );
        $columns[] = array(
            'data' => lang('reports_ip_address_clock_in'),
            'align' => 'left'
        );
        $columns[] = array(
            'data' => lang('reports_ip_address_clock_out'),
            'align' => 'left'
        );
        return $columns;
    }
