...
class Detailed_register_log extends Report
{
    ...
    public function getDataColumns()
    {
        return array(
            array(
                'data' => lang('common_delete'),
                'align' => 'left'
            ),
            array(
                'data' => lang('common_det'),
                'align' => 'left'
            ),
            array(
            ...
            array(
                'data' => lang('reports_employee_open'),
                'align' => 'left'
            ),
            array(
                'data' => lang('reports_close_employee'),
                'align' => 'left'
            ),
            array(
                'data' => lang('reports_shift_start'),
                'align' => 'left'
            ),
            array(
                'data' => lang('reports_shift_end'),
                'align' => 'left'
            ),
            array(
                'data' => lang('common_open_amount'),
                'align' => 'left'
            ),
            array(
                'data' => lang('reports_close_amount'),
                'align' => 'left'
            ),
            array(
                'data' => lang('common_cash_sales'),
                'align' => 'left'
            ),
            array(
                'data' => lang('common_total_cash_additions'),
                'align' => 'left'
            ),
            array(
                'data' => lang('common_total_cash_subtractions'),
                'align' => 'left'
            ),
            array(
                'data' => lang('reports_difference'),
                'align' => 'left'
            ),
            array(
                'data' => lang('reports_notes'),
                'align' => 'left'
            )
        );
    }
    ...
    public function delete_register_log($register_log_id)
    {
        ...
        $this->db->update('register_log', array(
            'deleted' => 1
        ));
        
        $this->db->where('register_log_id', $register_log_id);
        $this->db->where('shift_end', '0000-00-00 00:00:00');
        return $this->db->update('register_log', array(
