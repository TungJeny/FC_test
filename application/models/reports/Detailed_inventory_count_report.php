...
class Detailed_inventory_count_report extends Report
{
    ...
    public function getDataColumns()
    {
        ...
        $return['summary'][] = array(
            'data' => lang('reports_count_date'),
            'align' => 'left'
        );
        $return['summary'][] = array(
            'data' => lang('common_status'),
            'align' => 'left'
        );
        $return['summary'][] = array(
        ...
        $return['summary'][] = array(
            'data' => lang('reports_number_items_counted'),
            'align' => 'left'
        );
        $return['summary'][] = array(
            'data' => lang('reports_amount_over_under_from_actual_on_hand'),
            'align' => 'left'
        );
        $return['summary'][] = array(
            'data' => lang('reports_total_difference'),
            'align' => 'left'
        );
        $return['summary'][] = array(
            'data' => lang('common_comments'),
            'align' => 'left'
        );
        ...
        $return['details'][] = array(
            'data' => lang('reports_actual_count'),
            'align' => 'left'
        );
        $return['details'][] = array(
