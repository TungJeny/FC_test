...
class Detailed_expenses extends Report
{
    ...
    public function getDataColumns()
    {
        $columns = array(
            ...
            array(
                'data' => lang('common_recipient_name'),
                'align' => 'left'
            ),
            array(
                'data' => lang('common_approved_by'),
                'align' => 'left'
            ),
            array(
                'data' => lang('common_expenses_note'),
                'align' => 'left'
            )
        );
