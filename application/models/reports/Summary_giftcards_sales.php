...
class Summary_giftcards_sales extends Report
{
    ...
    public function getDataColumns()
    {
        ...
        $return = array(
            array(
                'data' => lang('reports_sale_date'),
                'align' => 'left'
            ),
            array(
                'data' => lang('common_giftcards_giftcard_number'),
                'align' => 'left'
            ),
            array(
                'data' => lang('reports_sales_generator_selectField_1'),
                'align' => 'left'
            ),
            array(
                'data' => lang('reports_giftcard_sale_amount'),
                'align' => 'left'
            )
        );
