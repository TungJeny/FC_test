...
class Location extends CI_Model
{
    ...
    function assign_employees_to_location($location_id, $employees)
    {
        ...
        $this->db->delete('employees_locations', array(
    ...
    {
        return $this->db->update('locations', array(
            'default_tax_1_rate' => '',
            'default_tax_2_rate' => '',
            'default_tax_3_rate' => '',
            'default_tax_4_rate' => '',
    ...
    function get_quantily_of_item_location($loacation_id, $item_id){

        $this->db->from('location_items');
        $this->db->where('location_id', $loacation_id);
