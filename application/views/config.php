		...
		<div class="col-md-12">
			<div class="panel panel-piluku">
				...
				<div class="panel-body">
					...
					<div id="average_cost_price_from_receivings_methods" data-keyword="<?php echo H(lang('config_keyword_sales')) ?>">
			...
			<div class="panel panel-piluku">
				...
				<div class="email_advanced">	
					...
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_email')) ?>">	
						...
						<div class="col-sm-9 col-md-9 col-lg-10">
							<?php
								$newline_options = array("\r\n"=>'\r\n',"\n"=>'\n',"\r"=>'\r');
								echo form_dropdown('newline', $newline_options, $this->config->item('newline') ? $this->config->item('newline') : "\r\n", 'id="newline" class="form-control"');
							?>
						</div>
					</div>
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_email')) ?>">	
						...
						<div class="col-sm-9 col-md-9 col-lg-10">
							<?php
								$newline_options = array("\r\n"=>'\r\n',"\n"=>'\n',"\r"=>'\r');
								echo form_dropdown('crlf', $newline_options, $this->config->item('crlf') ? $this->config->item('crlf') : "\r\n", 'id="crlf" class="form-control"');
							?>
						</div>
					</div>
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_email')) ?>">
