		...
		<?php } ?>
			...
			<div class="panel panel-piluku">
				...
				<div class="panel-body">
					...
					<div class="form-group">
					<?php echo form_label(lang('employees_is_shipper').':', 'is_shipper',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
							<?php
							echo form_checkbox(array(
								'name' => 'is_shipper',
								'id' => 'is_shipper',
								'value' => 1,
								'checked' => $person_info->is_shipper,
								));
								echo '<label for="is_shipper"><span></span></label>';;
							?>
						</div>
					</div>

					<div class="form-group">
					<?php echo form_label(lang('employees_is_importer').':', 'is_importer',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
							<?php
							echo form_checkbox(array(
								'name' => 'is_importer',
								'id' => 'is_importer',
								'value' => 1,
								'checked' => $person_info->is_importer,
								));
								echo '<label for="is_importer"><span></span></label>';;
							?>
						</div>
					</div>
	...
	success:function(response)
		{
			...
			else if(response.redirect_code==3 && response.success)
			{
				$.post('<?php echo site_url("Stock_in/select_employee");?>', {employee: response.person_id}, function()
				{
					window.location.href = '<?php echo site_url('stock_in'); ?>';
				});		
			}
