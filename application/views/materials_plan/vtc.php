		...
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane active" id="detail" v-show="!loading">
				<div style="padding-right: 0px;">
        			<div class="table-responsive" ref="fixedColumnTable">
        					...
        					<tbody id="fixedcolumnbody-detail" onscroll="fixscroll('detail')">
        						<tr v-for="material in materials">
        							...
        							<td v-for="month in months">
                                        <span class="summary_material--input-data" v-if="material.type == 'qty_booked'"  > {{ materials_matrix[material.material_id][month][material.type] }}</span>
        								<!-- <input v-if="material.type == 'qty_booked'" v-model="materials_matrix[material.material_id][month][material.type]"/> -->

                                        <span v-else-if="material.type == 'qty_esitmate'" >{{ materials_matrix[material.material_id][month][material.type] }}</span>

        								<!-- <input class="input_inventory summary_material--input-data" v-else-if="material.type == 'qty_esitmate'" id="total_number_matrix" v-model="materials_matrix[material.material_id][month][material.type]"/> -->

                                        <span v-else-if="material.type == 'qty_actual_income'"> {{ materials_matrix[material.material_id][month][material.type] }} </span>
        								<!-- <input v-else-if="material.type == 'qty_actual_income'" v-model="materials_matrix[material.material_id][month][material.type]"/> -->
                                       
                                        <input class="input_inventory summary_material--input-data" v-else-if="material.type == 'qty_inventory'" v-model="materials_matrix[material.material_id][month][material.type]">
        								<span class="summary_material--input-data" v-else>
        			...
        			<div class="fixed-column-outter">
        				<table class="table">
        					<thead>
        						<tr>
        							<th rowspan="3">
        								<span style="float: left;">TÊN VẬT TƯ 1</span>
...
"/>
	...
	<div class="form-actions pull-right">
		<input type="button" value="Tồn kho" class="submit_button floating-button btn btn-primary uppercase" @click="update_stock_report" style="margin-right: 80px;" >
		<input type="submit" value="submit" class="submit_button floating-button btn btn-primary uppercase" @click="fnSave" >
	</div>
