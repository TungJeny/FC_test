				...
				<div class="form-group">	
					...
					<div id="merchant_information">
						...
						<div class="form-group">	
							...
							<div class="col-sm-9 col-md-9 col-lg-10">
							<?php echo form_dropdown('credit_card_processor', array('mercury' => 'Vantiv/Mercury','heartland' => 'Heartland', 'evo' => 'EVO','worldpay' => 'Worldpay', 'stripe' => 'Stripe','braintree' => 'Braintree', 'other_usb' => lang('locations_other_emv_processor')), $location_info->credit_card_processor, 'class="form-control" id="credit_card_processor"');
								?>
							</div>
						</div>
		...
		{			
         ...
         $('#color').colorpicker();
			...
			function check_credit_card_processor()
			{
				...
				else if(cc_processor == 'heartland' || cc_processor == 'evo' || cc_processor == 'worldpay' || cc_processor == 'other_usb')
				{
					$("#emv_info").show();
