	...
	<div class="row manage-table">
		<div class="panel panel-piluku">
			...
			<div class="panel-body nopadding table_holder table-responsive" >
				<list-view :data="attribute_groups" :columns="displayCols" :pagination="pagination" :options="options" :loading="loading" v-on:sorting="sort" v-on:clickonlink="click_on_link" v-on:selectingrow="selectingRow">{{attribute_groups}}</list-view>
			</div>
		</div>
	</div>
</div>
