			...
			<div class="panel-body panel-pad">
			    ...
			    <div class="invoice-table">
			        <div class="row">
			            ...
			            <div class="col-md-1 col-sm-1 col-xs-1">
			                <div class="invoice-head invoice-heading">Số lượng</div>
			            </div>
			            <div class="col-md-3 col-sm-3 col-xs-3">
			                <div class="invoice-head invoice-heading">Đơn giá</div>
			            </div>
			            <div class="col-md-2 col-sm-2 col-xs-2">
			                <div class="invoice-head invoice-heading">Thành tiền</div>
			            </div>
			        </div>
			    </div>
			    <?php
                ...
                <div class="invoice-table-content">
                    <div class="row">
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-1">
                            <div class="invoice-content invoice-con text-center"><?php echo to_quantity($item['quantity']); ?></div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-3">
                            <div class="invoice-content invoice-con text-center"><?php echo to_currency($item['price']); ?></div>
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-2">
                            <div class="invoice-content invoice-con text-center"><?php echo to_currency($item['price']*$item['quantity']-$item['price']*$item['quantity']*$item['discount']/100); ?></div>
                        </div>
                    </div>
                </div>
			    <?php endforeach; ?>
