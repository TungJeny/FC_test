	...
	<?php echo form_open('suppliers/save/'.$person_info->person_id,array('id'=>'supplier_form','class'=>'form-horizontal')); ?>
			...
			<div class="panel-body">
				<div class="form-group">
				    ...
				    <div class="form-group">				
						<?php echo form_label(lang('suppliers_company_code').':', 'company_code', array('class'=>'required col-sm-3 col-md-3 col-lg-2 control-label')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10 cmp-inps">
						<?php echo form_input(array(
							'class'=>'form-control form-inps',
							'name'=>'company_code',
							'id'=>'company_code',
							'value'=>get_data($person_info, 'company_code'))
							);?>
						</div>
					</div>
...
$('#grid-loader').hide();
					...
					if(response.redirect==3 && response.success)
					{ 
						$.post('<?php echo site_url("Stock_in/select_supplier");?>', {supplier: response.person_id}, function()
						{
