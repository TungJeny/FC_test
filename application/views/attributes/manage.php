		...
		<div class="col-md-7">	
			<div class="buttons-list">
				<div class="pull-right-btn">
					<?php echo anchor("attribute_groups",
						'<span class="">'.lang('attribute_group_list').'</span>',
						array('id' => 'new-attr-gr-btn', 'class'=>'btn btn-primary btn-lg', 'title'=>lang('attribute_group_list')));
					?>
					...
					<?php echo anchor("$controller_name/view/-1",
						...
						array('id' => 'new-attr-btn', 'class'=>'btn btn-primary btn-lg', 'title'=>lang($controller_name.'_new')));
					}	
					?>
				</div>
			</div>				
	...
	<div class="row manage-table">
		<div class="panel panel-piluku">
			...
			<div class="panel-body nopadding table_holder table-responsive" >
				<list-view :data="attributes" :columns="displayCols" :pagination="pagination" :options="options" :loading="loading" v-on:sorting="sort" v-on:clickonlink="click_on_link" v-on:selectingrow="selectingRow">{{attributes}}</list-view>
			</div>
		</div>
	</div>
</div>
