			...
			<div class="col-md-12">
				<div class="panel-piluku panel">
					...
					<div class="panel-body">
						<a href="javascript:void(0);" class="add_parent_category" data-category_id="0">[<?php echo lang('items_add_root_category'); ?>]</a>
...
<script type='text/javascript'>	
	...
	$('#category_image').change(function (e) {
		$("#categories_form").find('#image-preview').attr('src', URL.createObjectURL(event.target.files[0]));
	...
	$(document).on('click', ".add_parent_category",function()
	{
		$("#categoryModalDialogTitle").html(<?php echo json_encode(lang('Thêm loại cha')); ?>);
		var parent_id = $(this).data('category_id');
		$("#categories_form").find('#parent_id').val(parent_id);
		$("#categories_form").attr('action',SITE_URL+'/items/save_category');
