		...
		<div class="panel panel-piluku">
			<div class="panel-body panel-pad">
				<div class="row">
			        ...
			        <div class="col-md-4 col-sm-4 col-xs-4">
			            <ul class="list-unstyled invoice-detail">
							<li id="sale_id"><span>PHIẾU XUẤT KHO</span></li>
							<li id="employee"><span>Ngày: </span><?php echo $transaction_time; ?></li>
			            </ul>
				...
				<div class = "row">
			        <div class="col-md-4 col-sm-4 col-xs-4">
						<ul class="list-unstyled">
                            <li class ="text-left">Người nhận hàng:</li>
                            <li class ="text-left">Đơn vi:</li>
                            <li class ="text-left">Địa chỉ:  </li>
                            <li class ="text-left">Diễn giải:</li>
						</ul>
			        </div>
			        <div class="col-md-4 col-sm-4 col-xs-4">
						<ul class="list-unstyled invoice-detail">
							<li class ="text-left"><span><?php echo isset($employee)? $employee : '' ?></span></li>
							<li class ="text-left"><span><?php echo isset($receiver_location_name)?  $receiver_location_name: '';?></span></li>
							<li class ="text-left"><span></span></li>
			        ...
			        <div class="col-md-4 col-sm-4 col-xs-4">
			        	<ul class="list-unstyled invoice-detail">
							<li class ="text-left"><span></span></li>
							<li class ="text-left"><span></span></li>
							<li class ="text-left"><span>Xuất tại kho:</span></li>
			            </ul>
			        </div>
		        </div>
				<!-- invoice heading-->
			    <div class="invoice-table">
			        <div class="row">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-2">
                            <div class="invoice-head invoice-heading">Mã lô VT</div>
                        </div>
			            <div class="col-md-1 col-sm-1 col-xs-1">
                ...
                <div class="invoice-table-content">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-2">
                            <div class="invoice-content invoice-con">
                                <div class="invoice-content-heading"><?php echo $item['package_code']; ?></div>
                            </div>
                        </div>
                        <div class="col-md-1 col-sm-1 col-xs-1">
                            <div class="invoice-content invoice-con">
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-1">
                            <div class="invoice-content"><?php echo to_quantity($item['total_quantity']); ?></div>
                        </div>
                        <div class="col-md-1 col-sm-1 col-xs-1">
		    ...
		    <div class="row form-group">
	            <div class="col-md-offset-8 col-sm-offset-8 col-xs-offset-4 col-md-2 col-sm-2 col-xs-2">
	                <div class="invoice-footer-heading">TỔNG CỘNG: <?php echo to_currency($total); ?></div>
	            </div>
	        </div>
