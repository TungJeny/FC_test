...
class Honda extends Order implements IAction
{
    ...
    public function view($order_for = '')
    {
        ...
        $this->CI->load->view('orders/honda', $data);
    }
    ...
    public function save($data_post)
    {
        ...
        $data['order_for'] = $data_post['order_for'];
    ...
    public function update($sale_monthly_id)
    {
        ...
        $data['order_for'] = $sales_monthly->get_by_id($sale_monthly_id)['order_for'];
        $data['sale_monthly_id'] = $sale_monthly_id;
        $this->CI->load->view('orders/honda', $data);
    }
