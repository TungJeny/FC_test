...
class Timeclocks extends Secure_area
{
    ...
    function in()
    {
        if (! $this->Employee->is_clocked_in() && $this->Employee->clock_in($this->input->post('comment'))) {
            echo json_encode(array(
                'success' => true,
                'message' => lang('timeclocks_clock_in_success')
            ));
        } else {
            echo json_encode(array(
                'success' => false,
                'message' => lang('timeclocks_clock_in_failure')
            ));
        }
    }
    ...
    function out()
    {
        if ($this->Employee->clock_out($this->input->post('comment'))) {
            echo json_encode(array(
                'success' => true,
                'message' => lang('timeclocks_clock_out_success')
            ));
        } else {
            echo json_encode(array(
                'success' => false,
                'message' => lang('timeclocks_clock_out_failure')
            ));
        }
    }
