...
class Languagecheck extends MY_Controller
{
    ...
    function index($disable_white_list = 0, $fix_missing_keys = 0, $fix_matching_english_keys = 0)
    {
        ...
        $this->output('h1', 'LifeTek - Language file checking and validation');
                                ...
                                if (! isset($lang[$key])) {
                                    ...
                                    if (! $disable_white_list) {
                                        $white_list = array(
                                            ...
                                            'config_module',
                                            'common_merchant_id',
                                            'config_moving_average',
                                            'items_csv_import',
                                            'common_tax_3',
                                            'common_tax_4',
                                            'common_tax_5',
                                            'sales_global_sale_discount',
                                            'sales_total',
                                            'receivings_total',
                                            'config_spreadsheet_format',
                                            'config_csv',
                                            'config_xlsx',
                                            'common_layaway',
                                            'reports_total',
                                            ...
                                            'common_det',
                                            'common_update',
                                            'common_barcode_labels',
                                            'common_dashboard',
                                            'config_website',
                                            'config_backup_database',
                                            'config_mailchimp_api_key',
                                            'config_hosted_checkout_merchant_password',
                                            ...
                                            'reports_month_11',
                                            'reports_month_12',
                                            'reports_sales_generator_selectCondition_1',
                                            'reports_sales_generator_selectCondition_5',
                                            'reports_credit',
                                            'common_sub_total',
                                            'sales_sub_total',
                                            'config_application_settings_info',
                                            'config_medium',
                                            'item_id',
                                            'common_percentage',
                                            'locations_registers',
                                            ...
                                            'common_week',
                                            'common_tags',
                                            'common_clear_selection',
                                            'common_fields',
                                            'common_credit_card_processing',
                                            'config_enable_timeclock',
                                            'config_emv_merchant_id',
                                            'config_com_port',
                                            'common_employees_message',
                                            'employees_timeclock',
                                            'giftcards_log',
                                            'item_kits_id',
                                            'items_edit_status',
                                            ...
                                            'reports_tiers',
                                            'reports_credits',
                                            'reports_gift_card_sales_reports',
                                            'reports_open',
                                            'common_status',
                                            'reports_data',
                                            'reports_tiers_summary_report',
                                            'reports_tags_summary_report',
                                            'sales_merchant_copy',
                                            'common_show_grid',
                                            'lookup_receipt',
                                            'expenses_id',
                                            ...
                                            'expense_date',
                                            'common_open',
                                            'common_mailing_labels',
                                            'common_name',
                                            'common_tag',
                                            'common_template',
                                            'config_advanced',
                                            'config_loyalty_option',
                                            'config_store_account_statement_message',
                                            'config_production',
                                            'config_simple',
                                            'config_mailing_labels_type',
                                            'config_point_value',
                                            'config_test_mode',
                                            'customers_taxable',
                                            'customers_import',
                                            'messages_inbox',
                                            'receivings_email_po',
                                            'receivings_purchase_order',
                                            'reports_time_range',
                                            'reports_audit_report',
                                            'reports_date',
                                            'reports_min',
                                            'reports_name',
                                            'reports_month_08',
                                            'reports_store_account_statements',
                                            'reports_total_receivings',
                                            'expenses_basic_information',
                                            'items_view_count',
                                            'items_date',
                                            'items_non_taxable',
                                            'items_import',
                                            'items_are_you_sure_cancel',
                                            'items_unit_price_value',
                                            'items_promo_price_value',
                                            'items_scan_and_set',
                                            'locations_credit_card_processor',
                                            'locations_emv_terminal_id',
                                            'locations_braintree_public_key',
                                            'locations_braintree_private_key',
                                            'locations_mailchimp_api_key',
                                            'locations_stripe_private',
                                            'locations_name',
                                            'locations_com_port',
                                            'reports_subtotal',
                                            'sales_unredeem',
                                            'sales_type',
                                            'sales_entry_method',
                                            'sales_undeleted_voided',
                                            'common_item',
                                            'common_item_number_expanded',
                                            'item_kits_item',
                                            'reports_balance_to_pay',
                                            'common_ebt',
                                            'common_ebt_cash',
                                            'common_download_spreadsheet_template',
                                            'common_database_field_mappings_must_be_unique',
                                            'common_database_field',
                                            'common_desktop',
                                            'common_test',
                                            'common_minutes',
                                            'title_cron_documentation',
                                            'common_mobile',
                                            'woo_cron_job_entry',
                                            'common_margin',
                                            'common_cost_plus_percent',
                                            'config_email_crlf',
                                            'config_enable_margin_calculator',
                                            'config_last_sync_date',
                                            'config_smtp_crypto',
                                            'config_smtp_host',
                                            'config_smtp_timeout',
                                            'config_barcodes_info',
                                            'config_store_accounts_info',
                                            'config_payment_types_info',
                                            'config_keyword_barcodes',
                                            'config_keyword_items',
                                            'config_keyword_store_accounts',
                                            'config_woo_version',
                                            'config_ecommerce_progress',
                                            'config_sync',
                                            'config_send_test_email',
                                            'config_keyword_taxes',
                                            'config_keyword_profit',
                                            'config_woo_api_url',
                                            'config_woo_api_key',
                                            'home_ecommerce_platform_sync',
                                            'items_in_spreadsheet',
                                            'items_image_alt_text',
                                            'items_duplicate_item_number',
                                            'locations_ip_tran_device_id',
                                            'locations_secure_device_override_emv',
                                            'locations_net_e_pay_server',
                                            'locations_terminal_id',
                                            'migrate_title',
                                            'migrate_quickbooks_aaatex_integration',
                                            'migrate_device_override_emv',
                                            'migrate_sessions_table_change',
                                            'migrate_new_import',
                                            'price_rules_select_tags',
                                            'simple_discount',
                                            'price_rules_id',
                                            'price_rules_new',
                                            'price_rules_status',
                                            'spend_x_get_discount',
                                            'price_rules_select_item_kits',
                                            'price_rules_percent_discount_per_unit',
                                            'receivings_pays_receivings',
                                            'sales_ebt_balance_amount',
                                            'reports_variance',
                                            'reports_outstanding_recv',
                                            'sales_ebt_cash_balance',
                                            'sales_ebt_balance'
