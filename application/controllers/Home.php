...
class Home extends Secure_area
{
    ...
    function view_item_modal($item_id)
    {
        ...
        $data['selected_suppliers'] = implode(',', $this->Supplier->get_suppliers_for_item_name($item_id));
    ...
    function get_ecommerce_sync_progress()
    {
        if ($this->config->item("ecommerce_platform")) {
            ...
            echo json_encode(array(
                'running' => $this->Appconfig->get_raw_ecommerce_cron_running() ? $this->Appconfig->get_raw_ecommerce_cron_running() : FALSE,
