    ...
    public function do_start_cc_processing()
    {
        ...
        if ($CmdStatus == 'Approved') {
            ...
            if ($Authorize == $Purchase) {
                ...
                if (($this->controller->sale_lib->get_save_credit_card_info()) && $this->controller->sale_lib->get_customer() != - 1 || ($this->controller->sale_lib->get_customer() != - 1 && $this->controller->sale_lib->get_use_saved_cc_info())) {
                    $person_info = array(
            ...
            if ($CmdStatus == 'Declined') {
                ...
                $this->controller->_reload(array(
                    'error' => $CmdStatus . ': ' . urldecode($TextResponse)
                ), false);
            }
        }
    }
